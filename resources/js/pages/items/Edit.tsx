            ...
            <form onSubmit={handleSubmit} encType="multipart/form-data" className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className={`border-2 ${errors.name ? "border-red-300 focus:border-red-500" : "border-pink-200 focus:border-pink-500"} focus:ring-pink-200`}
                  required
                />
                {errors.name && (
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className={`border-2 ${errors.description ? "border-red-300 focus:border-red-500" : "border-pink-200 focus:border-pink-500"} focus:ring-pink-200`}
                />
                {errors.description && (
                  <div className="flex items-center text-red-600 text-sm mt-1">
                    <AlertCircle className="h-4 w-4 mr-1" />
              ...
              <div className="space-y-2">
                ...
                <div
                  className={`border-2 border-dashed rounded-lg p-6 text-center ${errors.image ? "border-red-300 bg-red-50" : previewUrl ? "border-green-300 bg-green-50" : "border-pink-200 hover:border-pink-400 bg-pink-50/50"} transition-all cursor-pointer`}
              ...
              <div className="space-y-2">
                ...
                <Select name="status" value={data.status} onValueChange={handleSelectChange} required>
                  <SelectTrigger
                    id="status"
                    className={`border-2 ${errors.status ? "border-red-300 focus:border-red-500" : "border-pink-200 focus:border-pink-500"} focus:ring-pink-200`}
                  >
